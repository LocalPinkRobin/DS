...
public class BotonCambio extends javax.swing.JFrame implements Observer {
    ...
    public BotonCambio() {
        initComponents();
        jLabelTemperatura.setText("Indetermindao");
    }
    ...
    public void update(Observable obs, Object args) {
        jLabelTemperatura.setText( ((Temperatura) obs).getState().toString() );
    }
    
    /* TODO hacer que sea una hebra */
    ...
    private void initComponents() {
        ...
        jLabelTemperatura.setText("Valor");

        jLabel3.setText("ºC");

        jLabel4.setText("Cambiar valor por");

        jTextFieldTemperatura.setText("Nueva Temperatura");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(128, 128, 128)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jTextFieldTemperatura, javax.swing.GroupLayout.PREFERRED_SIZE, 128, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButtonCambiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonCambiarActionPerformed
        ...
        if (obs instanceof Temperatura) {
            String auxString = jTextFieldTemperatura.getText();
            tempAux = Double.parseDouble(auxString);
            ((Temperatura) obs).setState(tempAux);
        }
